 ...
 * @date 20150717
 */
public class ReceivePushMessageOperatorView extends PushView
        implements
            ISessionView,
            OnClickListener {

    public static final String TAG = ReceivePushMessageOperatorView.class.getSimpleName();
    ...
    @SuppressLint("NewApi")
    public ReceivePushMessageOperatorView(Context context, PushModle pushModle, String scheduleType) {
        super(context);
