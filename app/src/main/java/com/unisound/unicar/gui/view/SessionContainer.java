 ...
 * @ModifyBy: xiaodong.he
 * @ModifyDate 2016-1-29
 */
...
public class SessionContainer extends ScrollView {
    ...
    /**
     * addSessionView CENTER_VERTICAL
     * 
     * @param view
     * @param fullScroll
     */
    public void addSessionView(View view, boolean fullScroll) {
        ...
        addSessionView(view, fullScroll, Gravity.CENTER_VERTICAL);
    }
     ...
     * @param gravity
     */
    public void addSessionView(View view, boolean fullScroll, int gravity) {
        if (view == null) {
        ...
        // }
        // }
        Logger.d(TAG, "addSessionView--fullScroll =" + fullScroll + "; gravity:" + gravity);
        setScrollingEnabled(true);
        mRequestFullScroll = fullScroll;
        if (gravity != 0) {
            mSessionContainer.setGravity(gravity);
        }
        mSessionContainer.addView(view);
    }

    /**
     * added SessionListView
     * 
     * @author xiaodong.he
     * @date 2015-07-16
     ...
     * @param view
     */
    public void addSessionListView(View view, int gravity) {
        if (view == null) {
            Logger.w(TAG, "addSessionListView: view null,return!");
            return;
        }
