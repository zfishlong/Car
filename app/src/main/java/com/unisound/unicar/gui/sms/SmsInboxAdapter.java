...
public class SmsInboxAdapter extends BaseAdapter {
        ...
        if (mCursor.moveToFirst()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (name != null) {
                    ...
                    // Logger.i("Test" , "the name is :" + name.toString());
    ...
    public int loadNextPage() {
        if (mCurrentPage < mPages) {
            ...
            Logger.i("Test", "mCurrentPage :" + mCurrentPage);
            Logger.i("Test", "CurrentCursor :" + count + " end: " + end);
            Logger.i("Test", "nextCursorend:" + (count + mPageSize));
            Logger.i("Test", "-------------------");
