 ...
 * 
 * @FileName : RomCustomReceiver.java
...
public class RomCustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (RomCustomConstant.ACTION_CUSTOM_UPDATE_CONTACT.equals(action)) {
        ...
        if (mThread == null) {
            mThread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Logger.d(TAG, "insertContactInfosInNewThread sync end");
                    mThread = null;
                }
            });
        }
        if (!mThread.isAlive()) {
            Logger.d(TAG, "insertContactInfosInNewThread start sync");
            mThread.start();
        }
    }
