...
public class AllFunctionsActivity extends BaseActivity {
    ...
    private ImageViewWithText btnWechat;
        ...
        public Object instantiateItem(View container, int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    btnWechat = (ImageViewWithText) findViewById(R.id.btn_function_wechat);
                    ...
                    btnWechat.setOnClickListener(mOnClickListener);
        ...
        public void onClick(View v) {
            ...
            // page1 line1
                ...
                case R.id.btn_function_quick_setting:
                    ...
                    break;
                // page1 line2
                case R.id.btn_function_wechat:
                    helpType = GUIConfig.VALUE_FUNCTION_HELP_TYPE_WECHAT;
                    helpTitle = btnWechat.getShowText();
                    break;
