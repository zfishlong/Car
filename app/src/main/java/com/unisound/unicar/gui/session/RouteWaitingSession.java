...
public class RouteWaitingSession extends BaseSession {
    ...
    public void putProtocol(JSONObject jsonProtocol) {
        ...
        mPathPoints = JsonTool.getJsonValue(mDataObject, "pathPoints");
            ...
            // search POI success
                ...
                if (infos != null) {
                    ...
                    for (PoiInfo poiInfo : infos) {
                        ...
                        locationInfo.setmPathPoints(mPathPoints);
                        locationInfos.add(locationInfo);
                    }
                    Logger.d(TAG, "locationInfos size : " + locationInfos.size()
                            + "locationInfos : " + JsonTool.toJson(locationInfos));
